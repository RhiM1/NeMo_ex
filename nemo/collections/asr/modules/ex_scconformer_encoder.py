...
__all__ = ['SelfConditionedExemplarConformerEncoder']
...
class SelfConditionedExemplarConformerEncoder(NeuralModule, Exportable):
    """
...
class SelfConditionedExemplarConformerEncoderAdapter(SelfConditionedExemplarConformerEncoder, adapter_mixins.AdapterModuleMixin):
...
"""
if adapter_mixins.get_registered_adapter(SelfConditionedExemplarConformerEncoder) is None:
    adapter_mixins.register_adapter(base_class=SelfConditionedExemplarConformerEncoder, adapter_class=SelfConditionedExemplarConformerEncoder)
