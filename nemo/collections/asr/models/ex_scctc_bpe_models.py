...
__all__ = ['EncDecExSCCTCModelBPE']


class EncDecExSCCTCModelBPE(EncDecExSCCTCModel, ASRBPEMixin):
    """Encoder decoder SC-CTC-based models with Byte Pair Encoding."""
    ...
    def change_vocabulary(
        ...
        del self.decoder
        self.decoder = EncDecExSCCTCModelBPE.from_config_dict(decoder_config)
        del self.loss
        self.loss = CTCLoss(
