...
__all__ = ['EncDecExSCCTCModel']


class EncDecExSCCTCModel(ASRModel, ExportableEncDecModel, ASRModuleMixin):
    ...
    def __init__(self, cfg: DictConfig, trainer: Trainer = None):
        ...
        self.preprocessor = EncDecExSCCTCModel.from_config_dict(self._cfg.preprocessor)
        self.encoder = EncDecExSCCTCModel.from_config_dict(self._cfg.encoder)
        ...
        self.decoder = EncDecExSCCTCModel.from_config_dict(self._cfg.decoder)
        ...
        if hasattr(self._cfg, 'spec_augment') and self._cfg.spec_augment is not None:
            self.spec_augmentation = EncDecExSCCTCModel.from_config_dict(self._cfg.spec_augment)
        else:
    ...
    def change_vocabulary(self, new_vocabulary: List[str], decoding_cfg: Optional[DictConfig] = None):
        ...
        if self.decoder.vocabulary == new_vocabulary:
            ...
            del self.decoder
            self.decoder = EncDecExSCCTCModel.from_config_dict(new_decoder_config)
            del self.loss
            self.loss = CTCLoss(
                num_classes=self.decoder.num_classes_with_blank - 1,
                zero_infinity=True,
    ...
    def training_step(self, batch, batch_nb):
        ...
        if isinstance(batch, DALIOutputs) and batch.has_processed_signal:
            ...
            log_probs, iterim_posteriors, encoded_len, greedy_predictions = self.forward(input_signal=signal, input_signal_length=signal_len, ex_labels=ex_labels)
